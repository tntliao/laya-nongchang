...
var wimg = "";
var ping = "";
var aaa, bbb;//bbb 合约类型
//支付地址
var payAddress = {
    tron: { aaaa: 'xxxxxxxxxxxx' },
    bn: { aaaa: 'xxxxxxx' }
}
// 合约地址
var contract = {
...
arr_chongzhi = [
    { num1: '100aaaa', num2: 100, price: 100, id: 1 },
    { num1: '300aaaa', num2: 300, price: 300, id: 2 },
    { num1: '500aaaa', num2: 500, price: 500, id: 3 },
    { num1: '1000aaaa', num2: 1000, price: 1000, id: 4 },
    { num1: '3000aaaa', num2: 3000, price: 3000, id: 5 },
    { num1: '5000aaaa', num2: 5000, price: 5000, id: 6 },
    { num1: '10000aaaa', num2: 10000, price: 10000, id: 7 },
    { num1: '30000aaaa', num2: 30000, price: 1, id: 8 }
];
// TPLOG  传送标记
...
var Game = (function (_super) {
    function Game() {
        ...
        new Promise((resolve, reject) => {
            ...
            if ('tron' == bbb) {
                aaa = new Wallet(contract.tron.aaaa, (res) => { console.log(res) }, { abi: abi.tron.aaaa })
            } else {
                aaa = new Wallet(contract.bn.aaaa, (res) => { console.log(res) }, { abi: abi.bn.aaaa })
            }
        })
    ...
    _proto.reset = function () {
        ...
        this.chou_txt2.text = "2aaaa一次";
        Laya.timer.frameaaaap(1, this, _this.zhixingfudong);
        for (var i = 0; i < 18; i++) {
    ...
    _proto.dubaifun = function () {
        if (!xianshi) {
            ...
            if (iszhongnum == 0) {
                var randdubai = Math.faaaar(Math.random() * 4)
                if (randdubai == 0) {
                    this.duibaitxt.text = "种植白茶以外的aaaa才可以偷取哦~"
                }
                if (randdubai == 1) {
            ...
            var randdubai = Math.faaaar(Math.random() * 5);
            if (randdubai != 0) {
                if (iszhongnum == 1 || iszhongnum == 6 || iszhongnum == 12 || iszhongnum == 18) {
                    var randdubai = Math.faaaar(Math.random() * 8)
                    if (randdubai == 0) {
    ...
    _proto.caijinfun = function (data) {
        ...
        _this.caijintxt.text = "恭喜玩家" + jianger + "获得彩金" + jiangnum + "aaaa！";
        isjinbi = true;
        Laya.timer.once(3000, this, function () {
            isjinbi = false;
            caijinnum = 0;
    ...
    _proto.jinbisheng = function () {
        var randx = Math.faaaar(Math.random() * 20 + 1);
        imgx = 260 + randx * 39;
                                    ...
                                    ajax({
                                        ...
                                        success: function (data) {
                                            ...
                                            if (data.status == 1) {
                                                ...
                                                Laya.timer.aaaap(1000, this, _this.shengfun, [_this.landid, zhongziid]);
                                                // _this.tudifun();
                ...
                success: function (data) {
                    ...
                    for (var i = 0; i < data.list.length; i++) {
                        arr_shop.push({
                            ...
                            id: data.list[i].id,
                            info: "每天12点产出" + Math.faaaar(clear(data.list[i].profit_out) / data.list[i].profit_day * 100) / 100 + ', ' + data.list[i].profit_day + "天产出" + data.list[i].profit_out,
                        })
                    }
    ...
    _proto.jishifun = function () {
        ...
        Laya.timer.aaaap(1000, this, this.daojishifun);
    }
    ...
    _proto.topay = function (data) {
        ...
        let currentPayAddress = bbb == 'tron' ? payAddress.tron.aaaa : payAddress.bn.aaaa
        aaa.send(currentPayAddress, data.price, { from: aaa.userWallet.address })
            .then(res => {
    ...
    _proto.chongzhileixing = function (data) {
        ...
        if (data == 1) {
            ...
            function tpPay(data) {
                // payAddress  fromAddress
                let currentPayAddress = bbb == 'tron' ? payAddress.tron.aaaa : payAddress.bn.aaaa
                aaa.send(currentPayAddress, data.price, { from: aaa.userWallet.address }).then(res => {
                    // 支付完成调用接口  data.price 金额  res 交易hash
                    ajax({
                        url: web_url + '/game/recharge/do',
                        type: 'post',
                        data: {
                            ...
                            czmoney: data.num2,
                            transactionHash: res,
                            // fromacc: aaa.userWallet.address,
        ...
        if (data == 1) {
            ajax({
                ...
                success: function (data) {
                    ...
                    _this.biaotilan.getChildAt(2).text = "消耗aaaa"
